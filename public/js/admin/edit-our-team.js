$(document).ready(function () {
    ...
    $("body").on("click", "#editOurTeam", function () {
        ...
        Data.append('editorder', editorder);
        ...
        $.ajax({
            url: BASE_URL + '/admin/update-our-team',
            type: 'post',
            data: Data,
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    setTimeout(function () {
                        window.location.href = BASE_URL + "/admin/our-team";
