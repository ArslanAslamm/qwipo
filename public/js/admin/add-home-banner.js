$(document).ready(function () {
    ...
    $("body").on("click", "#add_home_banner", function () {
        
        var bannerTitle = $.trim($("#home_bannner_title").val());
        var bannnerSubTitle = $.trim($("#home_bannner_sub_title").val());
        ...
        if (bannerTitle == "" || bannerTitle == null) {
            ...
            $("#home_bannner_title").focus();
            return false;
        }
        if (bannnerSubTitle == "" || bannnerSubTitle == null) {
            messageDisplay("Please enter sub title", 1500, "error");
            $("#home_bannner_sub_title").focus();
            return false;
        }
        ...
        Data.append('bannnerSubTitle', bannnerSubTitle);
        ...
        $.ajax({
            url: BASE_URL + '/admin/add-home-banner',
            type: 'post',
            data: Data,
