$(document).ready(function () {
    ...
    $("body").on("click", "#addStatistic", function () {

        var statisticsTitle = $.trim($("#statisticsTitle").val()); 
        var image_name = $("#file").val();
        var files = $('#file')[0].files;

        if (statisticsTitle == "" || statisticsTitle == null) {
        ...
        Data.append('statisticsTitle', statisticsTitle);
        ...
        $.ajax({
            url: BASE_URL + '/admin/add-statistics',
            type: 'post',
            data: Data,
